# Тестирование всех форматов Google Maps ссылок

## 📋 Инструкция:
1. Скопируйте любую ссылку из списка ниже
...
### ✅ Успешные случаи:
- Бот должен ответить ссылкой на Waze
- Формат: `https://waze.com/ul?ll=lat,lng&navigate=yes`

### ❌ Неудачные случаи:
- Бот должен показать сообщение об ошибке
...
1. ✅ **Распознавание координат** из разных форматов
2. ✅ **Обработка коротких ссылок** (maps.app.goo.gl)
3. ✅ **Поддержка DMS координат** (градусы, минуты, секунды)
4. ✅ **Обработка consent ссылок**
5. ✅ **Поддержка place ID**
6. ✅ **Обработка маршрутов**
7. ✅ **Поддержка просмотра улиц**
8. ✅ **Обработка кастомных карт**
9. ✅ **Поддержка временных меток**
10. ✅ **Обработка отзывов и фотографий** 